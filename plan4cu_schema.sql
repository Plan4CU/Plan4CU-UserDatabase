...
(
    ...
    expected_graduation_month VARCHAR(10),
...
VALUES ('CC', 'College of Arts and Sciences'),
       ('SEAS', 'School of Engineering and Applied Science'),
       ('GS', 'Graduate School of Arts and Sciences');

INSERT INTO Major (major_id, major_name, school_id)
VALUES ('COMS', 'Computer Science', 'SEAS'),
       ('MATH', 'Mathematics', 'CC'),
       ('ECON', 'Economics', 'GS'),
       ('PHYS', 'Physics', 'CC');
...
INSERT INTO MajorTrack (track_id, track_name, major_id)
VALUES (1, 'Applications', 'COMS'),
...
INSERT INTO Student (s_uni, first_name, last_name, grad_year, total_creds, major_id, track_id)
VALUES ('jmd1234', 'John', 'Doe', 2025, 60, 'COMS', 1),
       ('jrs4567', 'Jane', 'Smith', 2024, 90, 'MATH', 3),
       ('abj4128', 'Alice', 'Johnson', 2026, 30, 'PHYS', NULL),
       ('bwb8035', 'Bob', 'Brown', 2025, 80, 'MATH', NULL);

INSERT INTO Professor (p_uni, first_name, last_name)
VALUES ('dff9', 'Donald', 'Ferguson'),
...
INSERT INTO Section (section_id, section_num, p_uni, capacity, num_enrolled, day, start_time, end_time, semester, year)
VALUES (11941, 003, 'dff9', 250, 267, 'Fr', '10:10:00', '12:40:00', 'FA', 2024),
...
INSERT INTO Course (course_id, course_name, call_num, credits, is_prereq, has_prereq, is_core)
VALUES ('COMS4111W', 'Introduction to Databases', 11941, 3, FALSE, FALSE, FALSE),
...
INSERT INTO Waitlist (waitlist_id, section_id, capacity, num_enrolled)
VALUES (1, 11941, 250, 23),
       (2, 11837, 100, 10),
       (3, 12196, 210, 74),
       (4, 13270, 180, 11),
       (5, 11932, 250, 45),
...
INSERT INTO Joins (join_id, s_uni, waitlist_id, join_status)
VALUES (1, 'jmd1234', 1, TRUE),
       (2, 'abj4128', 4, TRUE),
       (3, 'bwb8035', 2, TRUE),
       (4, 'abj4128', 1, TRUE),
       (5, 'jrs4567', 6, TRUE),
...
INSERT INTO Requirement (req_id, req_name, fulfill_status)
VALUES (1, 'Global Core', 'IP'),
       (2, 'Science', 'OK'),
       (3, 'Humanities', 'SR'),
       (4, 'Writing', 'OK');

# INSERT INTO Requires (course_id, req_id, major_id, track_id, minor_id) VALUES
INSERT INTO Requires (course_id, req_id, major_id, track_id)
VALUES ('MATH1101UN', 2, 'MATH', NULL),
       ('ECON1105UN', 3, 'ECON', NULL);

INSERT INTO CulpaProf (c_prof_id, p_uni, rating)
VALUES (1, 'dff9', 4.80),
       (2, 'gd2572', 3.63),
       (3, 'skg21', 3.61),
       (4, 'er2741', 4.00);

INSERT INTO CulpaCourse (c_course_id, course_name, course_id)
VALUES (1, 'Introduction to Databases', 'COMS4111W'),
       (2, 'Calculus I', 'MATH1101UN'),
       (3, 'Principles of Economics', 'ECON1105UN'),
       (4, 'General Physics I', 'PHYS1201UN');

INSERT INTO Review (review_id, c_course_id, post_date, review_text, p_rating)
VALUES (1, 2, '2024-01-15', 'Engaging and practical course with excellent professor.', 4.7),
...
INSERT INTO wasReviewed (review_id, c_prof_id, c_course_id)
VALUES (1, 2, 2),
       (2, 3, 3),
       (3, 1, 1),
       (4, 4, 4);

INSERT INTO EquivCourses (course1, course2)
VALUES ('COMS3134W', 'COMS3137W');

INSERT INTO Schedule (s_uni, semester, year)
VALUES ('jmd1234', 'FA', 2024),
       ('jrs4567', 'SP', 2024);

INSERT INTO SchedCourse (sched_id, section_id)
VALUES (1, 11941), -- John Doe's FA 2024 schedule with "Introduction to Databases"
